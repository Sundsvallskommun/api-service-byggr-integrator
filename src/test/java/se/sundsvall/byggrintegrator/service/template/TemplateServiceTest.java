...
class TemplateServiceTest {
	...
	@Test
	void testGetDescriptionAndPropertyDesignationInHtml() {
	...
	@Test
	void testGetDescriptionAndPropertyDesignation_withNullErrand() {
		final var html = templateService.getDescriptionAndPropertyDesignation(null);
	...
	@Test
	void testGenerateFileList_withNullErrand() {
		final var html = templateService.generateFileList("1234", null, Map.of(), List.of());
